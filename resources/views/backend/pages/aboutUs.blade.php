        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 justify-content-center">
                <div class="card custom-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.aboutUsUpdate', $about) }}" method="POST"
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea id="summernote" name="description">{!! old('description', $about->description) !!}</textarea>
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 d-flex align-items-center" style="margin-bottom: -15px!important;">
                                    ...
                                    <div class="d-flex align-items-center">
                                         <img id="aboutImagePreview" class="img-thumbnail me-3"
                                            style="width: 50px; height: 50px;" 
                                            src="{{ route('imagecache', ['template' => 'ppsm', 'filename' => $about->fi()]) }}" 
                                            alt="{{$about->name}}">
                                        <input type="file" class="form-control" id="image" name="image"
                                         onchange="previewImage(event, 'aboutImagePreview')">
                                    </div>
                                    @error('image')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
