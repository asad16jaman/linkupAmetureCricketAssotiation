        ...
        <div class="row justify-content-center">
            <div class="col-xl-12 justify-content-center">
                <div class="card custom-card">
                    ...
                    <form action="{{ route('admin.teamMemberUpdate',$team) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" class="form-control " id="mobile" name="mobile"
                                                placeholder="Enter mobile" value="{{ old('mobile', $team->mobile) }}" required="">
                                        </div>
                                        @error('mobile')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="email" class="form-control " id="email" name="email"
                                                placeholder="Enter email" value="{{ old('email', $team->email) }}" required="">
                                        </div>
                                        @error('mobile')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control " id="role" name="role"
                                                placeholder="Enter role" value="{{ old('role', $team->role) }}" required="">
                                        </div>
                                        @error('role')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        ...
                                        <div class="col-md-9">
                                            <div class="d-flex align-items-center">
                                                <img id="memberImagePreview" class="img-thumbnail me-3"
                                                    style="width: 50px; height: 50px;" src="{{ route('imagecache', ['template' => 'ppsm', 'filename' => $team->fi()]) }}" alt="">
                                ...
                                <div class="col-md-6" style="margin-bottom: -10px!important;">
                                    ...
                                    <textarea name="address" id="address" class="form-control form-control-sm" rows="2"
                                        placeholder="Enter address">{{ old('address', $team->address) }}</textarea>
                                    @error('address')
                                ...
                                <div class="col-md-6" style="margin-bottom: -10px!important;">
                                    ...
                                    <textarea name="short_description" id="short_description" class="form-control form-control-sm" rows="2"
                                        placeholder="Enter short description">{{ old('short_description',$team->short_description) }}</textarea>
                        ...
                        <div class="card-body text-end">
                            <button class="btn btn-primary btn-sm px-5" type="submit">Update</button>
                        </div>
                    </form>
