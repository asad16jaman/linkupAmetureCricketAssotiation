...
@section('pageside')
  @include('admin.layout.sidebar',['page' => 'mision'])
@endsection
        ...
        <div class="page-inner">
            ...
            <div class="card">
                <div class="card-header pt-1 pb-0">
                    <h4 class="text-center">Store Company Mission & Vision</h4>
                </div>
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body p-3 ">
                        ...
                        <div class="row mb-2 mt-2 ms-2"> 
                            ...
                            <textarea name="description" class="form-control  $error('description') is-invalid $enderror"  id="description">{{ old('speech',optional($ch)->description) }}</textarea>      
                        </div>
