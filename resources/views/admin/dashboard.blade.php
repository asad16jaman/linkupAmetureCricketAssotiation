...
@section('bodyContent')
  ...
  <div class="container">
    ...
    <div class="page-inner">
      <div
        class="d-flex align-items-center justify-content-center align-items-md-center flex-column flex-md-row pt-2 pb-4">
        <div>
          <div class="card mb-1">
            <div class="card-body d-flex justify-content-center">
              <img src="{{ optional($company)->logo ? asset('storage') . '/' . $company->logo : "" }}"
                style="width:70px;height:55px" alt="">
            </div>
          </div>
        ...
        <div class="col-xl-3 col-md-6">
          <a href="{{ route('admin.slider') }}">
            <div class="card" style="background:#fdf2f8	">
              <div class="card-body text-center">
                <svg style="width:31px" class="svg-inline--fa fa-sliders-h fa-w-16 fa-2x" aria-hidden="true"
                  focusable="false" data-prefix="fas" data-icon="sliders-h" role="img" xmlns="http://www.w3.org/2000/svg"
        ...
        <div class="col-xl-3 col-md-6">
          <a href="{{ route('admin.management') }}">
            <div class="card" style="background:#f5f3ff">
              <div class="card-body text-center">
                <p class="d_icon"><i class="fas fa-futbol"></i></p>
                <h4>Players</h4>
              </div>
            </div>
          </a>
