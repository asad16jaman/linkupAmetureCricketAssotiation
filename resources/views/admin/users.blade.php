                            ...
                            <div class="col-md-6 col-12">
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        ...
                                        @enderror" {{ $editUser ? 'readonly' : '' }} name="username"
                                            value="{{  old('username', optional($editUser)->username)}}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="text" class="form-control p-1" name="fullname"
                                            value="{{ old('fullname', optional($editUser)->fullname) }}"
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-9 col-12">
                                        <input type="email" value="{{ old('email', optional($editUser)->email) }}"
                                            name="email" class="form-control p-1 @error('email') is-invalid
                            ...
                            <div class="col-md-6 col-12">
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 d-flex justify-content-center mt-1">
                                        ...
                                        <!-- hidden input -->
                                        <input type="file" name="picture" id="imageInput" name="image" accept="image/*"
                                            style="display: none;">
                                    </div>
                                </div>
                                                    ...
                                                    @forelse($allUsers as $user)
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td class="d-flex justify-content-center">
                                                                ...
                                                                <a href="{{ route('admin.users', ['id' => $user->id, 'page' => request()->query('page'), 'search' => request()->query('search')]) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-12 d-flex justify-content-end me-2">
                                            @if ($allUsers->previousPageUrl())
                                                <a href="{{ $allUsers->previousPageUrl() }}" class="btn btn-primary mx-2 p-1"><i
